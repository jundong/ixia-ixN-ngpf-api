...
proc GetObjHandle {obj} {
        set handleList [list]
        foreach hndObj $obj {
            lappend handleList [$hndObj cget -handle]
        }
        
        if { [llength $handleList] == 1 } {
            return [lindex $handleList 0]
        }
        return $handleList
}
...
#       None
# Eg:
#       enum fruit {apple blueberry cherry date elderberry}
#            fruit: apple => 0  
#            fruit@ 0     => apple
#--
